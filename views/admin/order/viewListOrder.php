                                  ...
                                  <div class='header'>
                                    ...
                                    <div class='company-tax col-6 '>
                                      <div class="row">
                                        ...
                                        <p class='col-6'><b>Color: </b><input type="color" name="color" class="color" style="width: inherit;" value="<?= $workorder->COLOR ?>"></p>
                      ...
                      <div class="modal-dialog modal-xl">
                        <div class="modal-content">
                          ...
                          <div class="modal-footer">
                            ...
                            <a href="<?= APP_URL . 'admin/deleteWorkOrder?id=' . $workorder->ID ?>" class="btn btn-danger">Eliminar</a>
                          </div>
                        </div>
                      </div>
                    </div>
