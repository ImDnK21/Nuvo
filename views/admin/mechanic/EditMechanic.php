...
<?php if (isset($_SESSION['editMechanic']) && isset($_SESSION['editMechanic_message_type'])) : ?>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <form action="<?= APP_URL . 'admin/UpdateMechanic' ?>" method="post" enctype="multipart/form-data">
        <div class="row">
          <div class="col-12 col-md-4">
            <div class="mb-3">
              <label class="form-label"><span style="color: red;">*</span><b> Rut: (Ej: XXXXXXXX-X) </b><span style="color: red;">*</span></label>
              <input type="text" name="rut" class="form-control" id="validarRut" value="<?= $mechanic->RUT ?>" required readonly>
            </div>
          </div>
          <div class="col-12 col-md-8">
            <div class="mb-3">
              <label class="form-label"><span style="color: red;">*</span><b> Nombres: </b><span style="color: red;">*</span></label>
              <input type="text" name="firstname" class="form-control" value="<?= $mechanic->FIRSTNAME ?>">
            </div>
          </div>
          <div class="col-12 col-md-8">
            <div class="mb-3">
              <label class="form-label"><span style="color: red;">*</span><b> Apellidos: </b><span style="color: red;">*</span></label>
              <input type="text" name="lastname" class="form-control" value="<?= $mechanic->LASTNAME ?>">
            </div>
          </div>
          <div class="col-12 col-md-4">
            <div class="mb-3">
              <label class="form-label"><span style="color: red;">*</span><b> Telefono de contacto: (+569XXXXXXXX) </b><span style="color: red;">*</span> </label>
              <input type="text" name="phone" class="form-control" maxlength="12" value="<?= $mechanic->PHONE ?>">
            </div>
          </div>
          <div class="col-12 col-md-8">
            <div class="mb-3">
              <label class="form-label"><b>Direccion:</b></label>
              <input type="text" name="address" class="form-control" value="<?= $mechanic->ADDRESS ?>">
            </div>
          </div>
          <div class="col-12 col-md-4">
            <div class="mb-3">
              ...
              <option value="<?php echo $mechanic->ID_COMMUNE;?>" hidden><?php echo $mechanic->NOMBRE;?></option>
          ...
          <div class="col-12 col-md-4">
            <div class="mb-3">
              ...
              <input type="text" name="date" class="form-control" value="<?= $mechanic->CREATED_AT ?> " readonly>
            </div>
          </div>
