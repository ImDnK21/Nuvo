...
<div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel">
  <div class="carousel-inner">
    ...
    <img src="<?= APP_URL . 'uploads/slides/abbey-road.jpg' ?>" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
    <img src="<?= APP_URL . 'uploads/slides/nevermind.jpg' ?>" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="<?= APP_URL . 'uploads/slides/ride-the-lightning.jpg' ?>" class="d-block w-100" alt="...">
    </div>
  </div>
